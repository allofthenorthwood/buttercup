...
function Hero(game, x, y) {
    ...
    this.animations.add('run', [4, 3, 2, 1], 6, true); // 6fps looped
...
PlayState.init = function (data) {
    ...
    const jumpFunc = function () {
        let didJump = this.hero.jump();
        if (didJump) {
            this.sfx.jump.play();
        }
    };
    this.keys.up.onDown.add(jumpFunc, this);
...
PlayState.preload = function () {
    ...
    this.game.load.spritesheet('hero', 'images/buttercup.png', 48, 48);
...
PlayState._spawnCoin = function (coin) {
    ...
    sprite.animations.add('rotate', [0, 1, 2, 3, 4, 5, 6], 8, true); // 6fps, looped
